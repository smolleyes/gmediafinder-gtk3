...
class Playlist(object):
    def __init__(self, gui):
        ...
        self.select_dialog = self.gui.gladeGui.get_object("select_playlist_dialog")
        self.select_scroll = self.gui.gladeGui.get_object('playlist_chooser_scroll')
        self.add_pl_btn = self.gui.gladeGui.get_object('add_playlist_btn2')
        self.create_playlist_dialog = self.gui.gladeGui.get_object("newcat_dialog")
        self.newcat_entry = self.gui.gladeGui.get_object("newcat_entry")
        self.add_playlist_btn = self.gui.gladeGui.get_object("add_playlist_btn")
        self.del_playlist_btn = self.gui.gladeGui.get_object("del_playlist_btn")
    ...
    def make_pb(self, tvcolumn, cell, model, riter):
        ...
        pb = self.treeview.render_icon(stock, Gtk.IconSize.MENU, None)
    ...
    def add(self, name, link, media, engine):
        ...
        catname = ''
        print rep
        if rep == 1 or rep == Gtk.ResponseType.DELETE_EVENT:
    ...
    def add_playlist(self,widget=None):
        ...
        if rep == Gtk.ResponseType.DELETE_EVENT or rep == 1:
