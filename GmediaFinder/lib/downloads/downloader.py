...
class Downloader(object):
    def __init__(self,mainGui):
        ...
        self.down_box = self.gladeGui.get_object("down_box")
        ...
        self.down_scroll.set_policy(Gtk.PolicyType.AUTOMATIC, Gtk.PolicyType.AUTOMATIC)
        self.down_scroll.add_with_viewport(self.down_container)
        self.down_box.add(self.down_scroll)
        self.active_down_label = self.gladeGui.get_object("active_down_label")
        self.path_btn = self.gladeGui.get_object("select_path_btn")
        ...
        cellrenderer_text.props.wrap_mode = Pango.WrapMode.WORD
